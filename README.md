...
`Flutter` `Dart` `Firebase` `Node.js` `Python` `Flask` `Swift (basic)` `Kotlin (basic)` `Unity 2D` `Figma` `Aseprite`

---

**Find me**

[linkedin](https://linkedin.com/in/yunusemreoozturk) · [yunusemreozturk1@hotmail.com](mailto:yunusemreozturk1@hotmail.com)
